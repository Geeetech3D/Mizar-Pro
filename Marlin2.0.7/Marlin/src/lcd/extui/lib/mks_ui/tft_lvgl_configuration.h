...
extern void my_feedback(lv_indev_drv_t * indev_driver, uint8_t event_id);
...
extern bool get_point(int16_t *x, int16_t *y);
extern bool get_point_raw(int16_t *x, int16_t *y);
