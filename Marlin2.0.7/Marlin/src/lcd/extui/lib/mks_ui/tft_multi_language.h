...
typedef struct common_menu_disp {
  ...
  const char *next;
  const char *previous;
	const char *machinesize;
	const char *baudrate;
	const char *hardware;
	const char *firmware;
	const char *mainboard;
	const char *marlinver;
	const char *killprintstop;
	const char *killpleasereset;
	const char *killreset;
	const char *restore_warn;
	const char *save;
} common_menu_def;
...
typedef struct leveling_menu_disp {
	...
	const char *level_heat;
	const char *back;
	const char *levelhome;
	const char *manuallevelwait;
	const char *autolevelstart;
	const char *zoffsetstart;
	const char *levelnext;
	const char *leveldone;
	const char *levelerror;
	const char *levelrecover;
	const char *manuallevelz;
	const char *levelforcestop;
	const char *levelstopover;
	const char *levelwarn;
	const char *levelyes;
	const char *levelno;
	const char *leveloptionssel;
	const char *compensate;
	const char *levelreturn;
	const char *homingwarn;
	const char *sensorchkbef;
	const char *sensorchkok;
	const char *sensorchkng;
	const char *saveok;
	const char *zoffsetvalue;
	const char *zoffsetadjust;
	const char *zoffsetcenter;
} leveling_menu_def;
...
typedef struct more_menu_disp {
  const char *title;
  const char *BLTouch_Set;
	const char *BLTouch_Auto;
	const char *BLTouch_Manu;
  const char *back;
} more_menu_def;
...
typedef struct filament_menu_disp {
  ...
  const char *change_filament_ready;
	const char *change_filament_start;
...
typedef struct print_file_dialog_disp {
  const char *title;
  const char *confirm;
  const char *print_continue;
  const char *cancle;
  const char *print_file;
  const char *cancle_print;
	const char *pause_print;
	const char *change_filament;
	const char *level_invalid;
  const char *retry;
  const char *stop;
	const char *start;
...
typedef struct touch_calibrate_disp {
  const char *title;
	const char *point1;
	const char *point2;
	const char *point3;
	const char *point4;
	const char *calibStatus;
} touch_calibrate_def;

extern touch_calibrate_def calibrate_menu;
