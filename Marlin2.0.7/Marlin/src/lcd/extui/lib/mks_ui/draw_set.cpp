...
void lv_draw_set(void)
{
  lv_obj_t *buttonAbout, *buttonBack;
	...
	lv_obj_t *buttonCalibrate, *labelCalibrate;
  ...
  buttonBack = lv_imgbtn_create(scr, NULL);
	buttonCalibrate = lv_imgbtn_create(scr, NULL);
  ...
  lv_imgbtn_set_style(buttonBack, LV_BTN_STATE_REL, &tft_style_label_rel);
	...
	lv_obj_set_event_cb_mks(buttonCalibrate, event_handler, ID_S_CALIBRATE, NULL, 0);
  lv_imgbtn_set_src(buttonCalibrate, LV_BTN_STATE_REL, "F:/bmp_machine_para.bin");
  lv_imgbtn_set_src(buttonCalibrate, LV_BTN_STATE_PR, "F:/bmp_clear.bin");
  lv_imgbtn_set_style(buttonCalibrate, LV_BTN_STATE_PR, &tft_style_label_pre);
  lv_imgbtn_set_style(buttonCalibrate, LV_BTN_STATE_REL, &tft_style_label_rel);
	lv_obj_set_hidden(buttonCalibrate, 1);
  ...
  lv_imgbtn_set_style(buttonLed, LV_BTN_STATE_REL, &tft_style_label_rel);
	...
	lv_obj_set_pos(buttonCalibrate, BTN_ROW2_COL2_POS);
  ...
  lv_btn_set_layout(buttonBack, LV_LAYOUT_OFF);
	lv_btn_set_layout(buttonCalibrate, LV_LAYOUT_OFF);
  ...
  lv_btn_set_layout(buttonFilament, LV_LAYOUT_OFF);
	...
	labelCalibrate = lv_label_create(buttonCalibrate, NULL);
  ...
  if (gCfgItems.multiple_language != 0)
  {
    ...
    lv_obj_align(labelBack, buttonBack, LV_ALIGN_IN_BOTTOM_MID, 0, BUTTON_TEXT_Y_OFFSET);
		...
		lv_label_set_text(labelCalibrate, calibrate_menu.title);
    lv_obj_align(labelCalibrate, buttonCalibrate, LV_ALIGN_IN_BOTTOM_MID, 0, BUTTON_TEXT_Y_OFFSET);
  }
