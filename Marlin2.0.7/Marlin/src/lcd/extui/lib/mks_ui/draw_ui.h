...
#define H_START_OFFSET			15
#define BTN_X_PIXEL       107   // TFT_screen.btn_x_pixel
...
#define BTN_ROW1_COL1_POS	H_START_OFFSET+INTERVAL_V, titleHeight
#define BTN_ROW1_COL2_POS	H_START_OFFSET+BTN_X_PIXEL + INTERVAL_V * 2, titleHeight
#define BTN_ROW1_COL3_POS	H_START_OFFSET+BTN_X_PIXEL * 2 + INTERVAL_V * 3, titleHeight
#define BTN_ROW1_COL4_POS	H_START_OFFSET+BTN_X_PIXEL * 3 + INTERVAL_V * 4, titleHeight

#define BTN_ROW2_COL1_POS	 H_START_OFFSET+INTERVAL_V, BTN_Y_PIXEL + INTERVAL_H + titleHeight
#define BTN_ROW2_COL2_POS 	H_START_OFFSET+BTN_X_PIXEL + INTERVAL_V * 2, BTN_Y_PIXEL + INTERVAL_H + titleHeight
#define BTN_ROW2_COL3_POS 	H_START_OFFSET+BTN_X_PIXEL * 2 + INTERVAL_V * 3, BTN_Y_PIXEL + INTERVAL_H + titleHeight
#define BTN_ROW2_COL4_POS 	H_START_OFFSET+BTN_X_PIXEL * 3 + INTERVAL_V * 4, BTN_Y_PIXEL + INTERVAL_H + titleHeight
...
extern touch_calibration_t calibration;
...
extern void calibration_reset(void);
