...
static const char assets[][LONG_FILENAME_LENGTH] = 
{
	...
	"bmp_filamentchange_dis.bin",
	"bmp_filament_off.bin",
	"bmp_filament_on.bin",
	"bmp_file.bin",
	"bmp_gradient.bin",
	"bmp_heatbas.bin",
	...
	"bmp_led_white.bin",
	"bmp_leveling.bin",
	"bmp_leveling_auto.bin",
	"bmp_leveling_manual.bin",
	"bmp_level_set.bin",
	"bmp_logo.bin",
	"bmp_machine_para.bin",
	"bmp_machine_para_dis.bin",
	"bmp_manual_off.bin",
	"bmp_mixing_entry.bin",
	"bmp_mixing_icon.bin",
	"bmp_motor_off.bin",
	"bmp_motor_off_cn.bin",
	"bmp_mov.bin",
	"bmp_move_clear.bin",
	"bmp_move_xAdd.bin",
	"bmp_move_xDec.bin",
...
uint32_t default_view_addroffset = 10;
