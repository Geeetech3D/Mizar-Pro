...
touch_calibrate_def calibrate_menu;
...
void machine_setting_disp()
{
  if (gCfgItems.language == LANG_SIMPLE_CHINESE)
  {
    ...
    machine_menu.key_return = KEY_RETURN_CN;
  ...
  else if (gCfgItems.language == LANG_COMPLEX_CHINESE)
  {
    ...
    machine_menu.key_return = KEY_RETURN_T_CN;
  ...
  else
  {
    ...
    machine_menu.key_return = KEY_RETURN_EN;
...
// wifi-list
  ...
  case LANG_SIMPLE_CHINESE:
    ...
    common_menu.operate_special_title = PRINTING_OPERATION_GBK;
		common_menu.machinesize = MACHINE_SIZE_CN;
		common_menu.baudrate = MACHINE_BAUDRATE_CN;
		common_menu.hardware = MACHINE_HARDWARE_CN;
		common_menu.firmware = MACHINE_FIRMWARE_CN;
		common_menu.mainboard = MACHINE_BOARD_CN;
		common_menu.marlinver = MARLIN_VERSION_CN;
		common_menu.killprintstop = KILL_PRINT_STOP_CN;
		common_menu.killpleasereset = KILL_PLEASE_RESET_CN;
		common_menu.killreset = MORE_CUSTOM1_TEXT_CN;
		common_menu.restore_warn = RESTORE_WARN_CN;
		common_menu.save = SAVE_DATA_CN;
    //
    ...
    tool_menu.leveling = TOOL_LEVELING_CN;
		tool_menu.manuleveling = TOOL_MANU_LEVELING_CN;
    ...
    preheat_menu.handheat_title = TITLE_HANDEHEAT_CN;
    preheat_menu.bas = BAS_PREHEAT_CN;
    preheat_menu.pla = PLA_PREHEAT_CN;
    preheat_menu.custom = CUS_PREHEAT_CN;
		preheat_menu.operation = OPERATION_PREHEAT_CN;
    //
    ...
    extrude_menu.temp_warn = EXTERDE_TEMP_WARN_TEXT_CN;
    //
    ...
    leveling_menu.level_heat = AUTO_LEVEL_HEAT_TEXT_CN;
    leveling_menu.levelhome = LEVELING_HOME_XYZ_CN;
    leveling_menu.manuallevelwait = LEVELING_BED_WAITING_CN;
		leveling_menu.autolevelstart = LEVELING_BED_START_CN;
		leveling_menu.zoffsetstart = LEVELING_ZOFFSET_START_CN;
    leveling_menu.levelnext = LEVELING_NEXT_POINT_CN;
    leveling_menu.leveldone = LEVELING_DONE_CN;
    leveling_menu.levelerror = LEVELING_ERROR_CN;
    leveling_menu.levelrecover = LEVELING_RECOVER_CN;
    leveling_menu.manuallevelz = LEVELING_MOVE_Z_CN;
		leveling_menu.levelforcestop = LEVELING_FORCE_STOP_CN;
		leveling_menu.levelstopover = LEVELING_STOP_OVER_CN;
		leveling_menu.levelwarn = LEVELING_WARN_CN;
		leveling_menu.levelyes = LEVELING_STATUS_YES_CN;
		leveling_menu.levelno = LEVELING_STATUS_NO_CN;
		leveling_menu.leveloptionssel = LEVELING_START_OPT_CN;	
		leveling_menu.compensate = LEVELING_COMPENSATE_CN;
		leveling_menu.levelreturn = LEVELING_RETURN_CN;
		leveling_menu.homingwarn = LEVELING_HOMING_WARN_CN;
		leveling_menu.sensorchkok = LEVELING_SENSOR_CHKOK_CN;
		leveling_menu.sensorchkng = LEVELING_SENSOR_CHKNG_CN;
		leveling_menu.sensorchkbef = LEVELING_SENSOR_CHECKB_CN;
		leveling_menu.saveok = LEVELING_SAVE_OK_CN;
		leveling_menu.zoffsetvalue = LEVELING_OFFSET_VALUE_CN;
		leveling_menu.zoffsetadjust = LEVELING_OFFSET_AJUST_CN;
		leveling_menu.zoffsetcenter = LEVELING_OFFSET_CENTER_CN;
    ...
    set_menu.buzzer = BUZZER_CN;
    set_menu.led = LED_CN;
    set_menu.led_white = LED_WHITLE_CN;
    set_menu.led_color = LED_COLOR_CN;
    set_menu.led_off = LED_OFF_CN;
    set_menu.Restore = RESTORE_DEFAULTS_CN;
		set_menu.Runout = FILAMENT_RUNOUT_CN;
    ...
    more_menu.BLTouch_Auto = MORE_AUTO_LEVEL_CN;
		more_menu.BLTouch_Manu= MORE_MANU_LEVEL_CN;
    // WIFI
    ...
    about_menu.wifi = ABOUT_WIFI_TEXT_CN;
		//
    calibrate_menu.title = TOUCH_CALIBRATE_CN;
    calibrate_menu.point1 = CALIB_POINT1_CN;
    calibrate_menu.point2 = CALIB_POINT2_CN;
    calibrate_menu.point3 = CALIB_POINT3_CN;
    calibrate_menu.point4 = CALIB_POINT4_CN;
    calibrate_menu.calibStatus = CALIB_STATUS_CN;
    ...
    filament_menu.change_filament_ready = FILAMENT_CHANGE_WAIT_CN;
		filament_menu.change_filament_start = FILAMENT_CHANGE_TEXT_CN;
    ...
    printing_menu.wait = PRINTING_WAIT_CN;
    ...
    // print_file_dialog_menu.title = TITLE_DIALOG_CONFIRM_CN;
        print_file_dialog_menu.print_continue = DIALOG_CONTINUE_CN;
    ...
    print_file_dialog_menu.level_invalid = DIALOG_LEVEL_INVALID_CN;
    print_file_dialog_menu.cancle_print = DIALOG_CANCEL_PRINT_CN;
		print_file_dialog_menu.pause_print = DIALOG_PAUSE_PRINT_CN;
		print_file_dialog_menu.change_filament = DIALOG_CHANGE_FILAMENT_CN;
    print_file_dialog_menu.retry = DIALOG_RETRY_CN;
    print_file_dialog_menu.stop = DIALOG_STOP_CN;
		print_file_dialog_menu.start = DIALOG_START_CN;
    ...
    pause_msg_menu.filaChange = MESSAGE_FILECHANGE_CN;
  ...
  case LANG_COMPLEX_CHINESE:
    ...
    preheat_menu.handheat_title = TITLE_HANDEHEAT_T_CN;
    preheat_menu.bas = BAS_PREHEAT_T_CN;
    preheat_menu.pla = PLA_PREHEAT_T_CN;
    preheat_menu.custom = CUS_PREHEAT_T_CN;
		preheat_menu.operation = OPERATION_PREHEAT_CN;
    //
    ...
    extrude_menu.temp_warn = EXTERDE_TEMP_WARN_TEXT_T_CN;
    //
    leveling_menu.title = TITLE_LEVELING_CN;
    ...
    leveling_menu.level_heat = AUTO_LEVEL_HEAT_TEXT_T_CN;
    leveling_menu.levelhome = LEVELING_HOME_XYZ_T_CN;
    leveling_menu.manuallevelwait = LEVELING_BED_WAITING_T_CN;
		leveling_menu.autolevelstart = LEVELING_BED_START_CN;
		leveling_menu.zoffsetstart = LEVELING_ZOFFSET_START_CN;
    leveling_menu.levelnext = LEVELING_NEXT_POINT_T_CN;
    leveling_menu.leveldone = LEVELING_DONE_T_CN;
    leveling_menu.levelerror = LEVELING_ERROR_T_CN;
    leveling_menu.levelrecover = LEVELING_RECOVER_T_CN;
    leveling_menu.manuallevelz = LEVELING_MOVE_Z_T_CN;
		leveling_menu.levelforcestop = LEVELING_FORCE_STOP_T_CN;
		leveling_menu.levelstopover = LEVELING_STOP_OVER_T_CN;
		leveling_menu.levelwarn = LEVELING_WARN_CN;
		leveling_menu.levelyes = LEVELING_STATUS_YES_CN;
		leveling_menu.levelno = LEVELING_STATUS_NO_CN;
		leveling_menu.leveloptionssel = LEVELING_START_OPT_CN;	
    ...
    set_menu.buzzer = BUZZER_T_CN;
    set_menu.led = LED_T_CN;
    set_menu.led_white = LED_WHITLE_T_CN;
    set_menu.led_color = LED_COLOR_T_CN;
    set_menu.led_off = LED_OFF_T_CN;
    set_menu.Restore = RESTORE_DEFAULTS_T_CN;
		set_menu.Runout = FILAMENT_RUNOUT_T_CN;
    ...
    more_menu.BLTouch_Auto = MORE_AUTO_LEVEL_T_CN;
		more_menu.BLTouch_Manu = MORE_MANU_LEVEL_T_CN;
    // WIFI
    wifi_menu.title = WIFI_TEXT;
    // wifi_menu.key = WIFI_KEY_TEXT_CN;
    // wifi_menu.ip = WIFI_IP_TEXT_CN;
    ...
    filament_menu.change_filament_ready = FILAMENT_CHANGE_TEXT_T_CN;
		filament_menu.change_filament_start = FILAMENT_CHANGE_TEXT_CN;
    ...
    printing_menu.wait = PRINTING_WAIT_T_CN;
    ...
    print_file_dialog_menu.level_invalid = DIALOG_LEVEL_VALID_T_CN;
    ...
    pause_msg_menu.filaChange = MESSAGE_FILECHANGE_T_CN;
  ...
  case LANG_ENGLISH:
    ...
    common_menu.operate_special_title = PRINTING_OPERATION_OTHER_LANGUGE;
		common_menu.machinesize = MACHINE_SIZE_EN;
		common_menu.baudrate = MACHINE_BAUDRATE_EN;
		common_menu.hardware = MACHINE_HARDWARE_EN;
		common_menu.firmware = MACHINE_FIRMWARE_EN;
		common_menu.mainboard = MACHINE_BOARD_EN;
		common_menu.marlinver = MARLIN_VERSION_EN;
		common_menu.killprintstop = KILL_PRINT_STOP_EN;
		common_menu.killpleasereset = KILL_PLEASE_RESET_EN;
		common_menu.killreset = MORE_CUSTOM1_TEXT_EN;
		common_menu.restore_warn = RESTORE_WARN_EN;
		common_menu.save = SAVE_DATA_EN;
    ...
    tool_menu.leveling = TOOL_LEVELING_EN;
		tool_menu.manuleveling = TOOL_MANU_LEVELING_EN;
    ...
    preheat_menu.handheat_title = TITLE_HANDEHEAT_EN;
    preheat_menu.bas = BAS_PREHEAT_EN;
    preheat_menu.pla = PLA_PREHEAT_EN;
    preheat_menu.custom = CUS_PREHEAT_EN;
		preheat_menu.operation = OPERATION_PREHEAT_EN;
    //
    ...
    extrude_menu.temp_warn = EXTERDE_TEMP_WARN_TEXT_EN;
    //
    ...
    leveling_menu.level_heat = AUTO_LEVEL_HEAT_TEXT_EN;
    leveling_menu.levelhome = LEVELING_HOME_XYZ_EN;
    leveling_menu.manuallevelwait = LEVELING_BED_WAITING_EN;
		leveling_menu.autolevelstart = LEVELING_BED_START_EN;
		leveling_menu.zoffsetstart = LEVELING_ZOFFSET_START_EN;
    leveling_menu.levelnext = LEVELING_NEXT_POINT_EN;
    leveling_menu.leveldone = LEVELING_DONE_EN;
    leveling_menu.levelerror = LEVELING_ERROR_EN;
    leveling_menu.levelrecover = LEVELING_RECOVER_EN;
    leveling_menu.manuallevelz = LEVELING_MOVE_Z_EN;
		leveling_menu.levelforcestop = LEVELING_FORCE_STOP_EN;
		leveling_menu.levelstopover = LEVELING_STOP_OVER_EN;
		leveling_menu.levelwarn = LEVELING_WARN_EN;
		leveling_menu.levelyes = LEVELING_STATUS_YES_EN;
		leveling_menu.levelno = LEVELING_STATUS_NO_EN;
		leveling_menu.leveloptionssel = LEVELING_START_OPT_EN;
		leveling_menu.compensate = LEVELING_COMPENSATE_EN;
		leveling_menu.levelreturn = LEVELING_RETURN_EN;
		leveling_menu.homingwarn = LEVELING_HOMING_WARN_EN;
		leveling_menu.sensorchkok = LEVELING_SENSOR_CHKOK_EN;
		leveling_menu.sensorchkng = LEVELING_SENSOR_CHKNG_EN;
		leveling_menu.sensorchkbef = LEVELING_SENSOR_CHECKB_EN;
		leveling_menu.saveok = LEVELING_SAVE_OK_EN;
		leveling_menu.zoffsetvalue = LEVELING_OFFSET_VALUE_EN;
		leveling_menu.zoffsetadjust = LEVELING_OFFSET_AJUST_EN;
		leveling_menu.zoffsetcenter = LEVELING_OFFSET_CENTER_EN;
    ...
    set_menu.buzzer = BUZZER_EN;
    set_menu.led = LED_EN;
    set_menu.led_white = LED_WHITLE_EN;
    set_menu.led_color = LED_COLOR_EN;
    set_menu.led_off = LED_OFF_EN;
    set_menu.Restore = RESTORE_DEFAULTS_EN;
		set_menu.Runout = FILAMENT_RUNOUT_EN;

    more_menu.title = TITLE_MORE_EN;
    more_menu.BLTouch_Auto = MORE_AUTO_LEVEL_EN;
		more_menu.BLTouch_Manu = MORE_MANU_LEVEL_EN;
    ...
    about_menu.wifi = ABOUT_WIFI_TEXT_EN;
		//
    calibrate_menu.title = TOUCH_CALIBRATE_EN;
    calibrate_menu.point1 = CALIB_POINT1_EN;
    calibrate_menu.point2 = CALIB_POINT2_EN;
    calibrate_menu.point3 = CALIB_POINT3_EN;
    calibrate_menu.point4 = CALIB_POINT4_EN;
    calibrate_menu.calibStatus = CALIB_STATUS_EN;
    ...
    filament_menu.change_filament_ready = FILAMENT_CHANGE_WAIT_EN;
		filament_menu.change_filament_start = FILAMENT_CHANGE_TEXT_EN;
    ...
    printing_menu.wait = PRINTING_WAIT_EN;
    ...
    // print_file_dialog_menu.title = TITLE_DIALOG_CONFIRM_EN;
        print_file_dialog_menu.print_continue = DIALOG_CONTINUE_EN;
    ...
    print_file_dialog_menu.level_invalid = DIALOG_LEVEL_INVALID_EN;
    print_file_dialog_menu.cancle_print = DIALOG_CANCEL_PRINT_EN;
		print_file_dialog_menu.pause_print = DIALOG_PAUSE_PRINT_EN;
		print_file_dialog_menu.change_filament = DIALOG_CHANGE_FILAMENT_EN;
    print_file_dialog_menu.retry = DIALOG_RETRY_EN;
    print_file_dialog_menu.stop = DIALOG_STOP_EN;
		print_file_dialog_menu.start = DIALOG_START_EN;
    ...
    pause_msg_menu.filaChange = MESSAGE_FILECHANGE_EN;
  ...
  case LANG_RUSSIAN:
    ...
    preheat_menu.handheat_title = TITLE_HANDEHEAT_RU;
    preheat_menu.bas = BAS_PREHEAT_RU;
    preheat_menu.pla = PLA_PREHEAT_RU;
    preheat_menu.custom = CUS_PREHEAT_RU;
		preheat_menu.operation = OPERATION_PREHEAT_EN;
    //
    ...
    extrude_menu.temp_warn = EXTERDE_TEMP_WARN_TEXT_RU;
    //
    ...
    leveling_menu.level_heat = AUTO_LEVEL_HEAT_TEXT_RU;
    leveling_menu.levelhome = LEVELING_HOME_XYZ_EN;
    leveling_menu.manuallevelwait = LEVELING_BED_WAITING_EN;
		leveling_menu.autolevelstart = LEVELING_BED_START_EN;
		leveling_menu.zoffsetstart = LEVELING_ZOFFSET_START_EN;
    ...
    filament_menu.change_filament_ready = FILAMENT_CHANGE_TEXT_RU;
    ...
    printing_menu.wait = PRINTING_WAIT_RU;
    ...
    pause_msg_menu.filaChange = MESSAGE_FILECHANGE_RU;
  ...
  case LANG_SPANISH:
    ...
    preheat_menu.handheat_title = TITLE_HANDEHEAT_SP;
    preheat_menu.bas = BAS_PREHEAT_SP;
    preheat_menu.pla = PLA_PREHEAT_SP;
    preheat_menu.custom = CUS_PREHEAT_SP;
		preheat_menu.operation = OPERATION_PREHEAT_EN;
    //
    ...
    extrude_menu.temp_warn = EXTERDE_TEMP_WARN_TEXT_SP;
    //
    ...
    leveling_menu.level_heat = AUTO_LEVEL_HEAT_TEXT_SP;
    leveling_menu.levelhome = LEVELING_HOME_XYZ_EN;
    leveling_menu.manuallevelwait = LEVELING_BED_WAITING_EN;
		leveling_menu.autolevelstart = LEVELING_BED_START_EN;
		leveling_menu.zoffsetstart = LEVELING_ZOFFSET_START_EN;
    ...
    filament_menu.change_filament_ready = FILAMENT_CHANGE_TEXT_SP;
		filament_menu.change_filament_start = FILAMENT_CHANGE_TEXT_EN;
    ...
    printing_menu.wait = PRINTING_WAIT_SP;
    ...
    pause_msg_menu.filaChange = MESSAGE_FILECHANGE_SP;
  ...
  case LANG_FRENCH:
    ...
    preheat_menu.handheat_title = TITLE_HANDEHEAT_FR;
    preheat_menu.bas = BAS_PREHEAT_FR;
    preheat_menu.pla = PLA_PREHEAT_FR;
    preheat_menu.custom = CUS_PREHEAT_FR;
		preheat_menu.operation = OPERATION_PREHEAT_EN;
    //
    ...
    extrude_menu.temp_warn = EXTERDE_TEMP_WARN_TEXT_FR;
    //
    ...
    leveling_menu.level_heat = AUTO_LEVEL_HEAT_TEXT_FR;
    leveling_menu.levelhome = LEVELING_HOME_XYZ_EN;
    leveling_menu.manuallevelwait = LEVELING_BED_WAITING_EN;
		leveling_menu.autolevelstart = LEVELING_BED_START_EN;
		leveling_menu.zoffsetstart = LEVELING_ZOFFSET_START_EN;
    ...
    filament_menu.change_filament_ready = FILAMENT_CHANGE_TEXT_FR;
		filament_menu.change_filament_start = FILAMENT_CHANGE_TEXT_EN;
    ...
    printing_menu.wait = PRINTING_WAIT_FR;
    ...
    pause_msg_menu.filaChange = MESSAGE_FILECHANGE_FR;
  ...
  case LANG_ITALY:
    ...
    preheat_menu.handheat_title = TITLE_HANDEHEAT_IT;
    preheat_menu.bas = BAS_PREHEAT_IT;
    preheat_menu.pla = PLA_PREHEAT_IT;
    preheat_menu.custom = CUS_PREHEAT_IT;
		preheat_menu.operation = OPERATION_PREHEAT_EN;
    //
    ...
    extrude_menu.temp_warn = EXTERDE_TEMP_WARN_TEXT_IT;
    //
    ...
    leveling_menu.level_heat = AUTO_LEVEL_HEAT_TEXT_IT;
    leveling_menu.levelhome = LEVELING_HOME_XYZ_EN;
    leveling_menu.manuallevelwait = LEVELING_BED_WAITING_EN;
		leveling_menu.autolevelstart = LEVELING_BED_START_EN;
		leveling_menu.zoffsetstart = LEVELING_ZOFFSET_START_EN;
    ...
    filament_menu.change_filament_ready = FILAMENT_CHANGE_TEXT_IT;
		filament_menu.change_filament_start = FILAMENT_CHANGE_TEXT_EN;
    ...
    printing_menu.wait = PRINTING_WAIT_IT;
    ...
    pause_msg_menu.filaChange = MESSAGE_FILECHANGE_IT;
  ...
  default:
    ...
    filament_menu.ext1 = FILAMENT_EXT0_TEXT_EN;
    filament_menu.ext2 = FILAMENT_EXT1_TEXT_EN;
    filament_menu.change_filament_ready = FILAMENT_CHANGE_TEXT_EN;
		filament_menu.change_filament_start = FILAMENT_CHANGE_TEXT_EN;
    filament_menu.filament_dialog_load_heat = FILAMENT_DIALOG_LOAD_HEAT_TIPS_EN;
    filament_menu.filament_dialog_load_heat_confirm = FILAMENT_DIALOG_LOAD_CONFIRM1_TIPS_EN;
    filament_menu.filament_dialog_loading = FILAMENT_DIALOG_LOADING_TIPS_EN;
